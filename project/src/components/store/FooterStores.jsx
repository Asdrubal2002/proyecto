...
function FooterStores({
  ...
  const navigation = {
    ...
    support: [
      ...
      { name: store&&store.location },
      { name: store&&store.address },
    ],
    company: [
      { name: store&&store.schedule },
    ],
    legal: [
      { name: store&&store.phone },
      { name: store&&store.email }
    ],
    social: [
      {
        name: 'Facebook',
        href: store&&store.facebook,
        icon: (props) => (
