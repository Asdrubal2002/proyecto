...
ECCOMERCE_APP=['apps.store_category',
               'apps.store',
               'apps.locations',
               'apps.product',
...
INSTALLED_APPS = DJANGO_APPS + PROJECT_APPS + ECCOMERCE_APP + THIRD_PARTY_APPS
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///ruvloDB"),
}
...
# Framework
#Quien puede interactuar con nuestra API
