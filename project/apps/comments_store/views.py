...
class ComentStoreAPIView(APIView):
    def get(self, request, store_slug):
        ...
        comentarios = Coment_store.objects.filter(store__slug=store_slug).order_by('-created')

        # Serializar los comentarios con el contexto de la solicitud
        serializer = ComentStoreSerializers(comentarios, many=True, context={'request': request})
    ...
    def post(self, request: Request, format=None):
        try:
            ...
            if serializer.is_valid():
                ...
                comentarios = Coment_store.objects.filter(store__id=store_slug).order_by('-created')
                comment_serializer = ComentStoreSerializers(comentarios, many=True, context={'request': request})
