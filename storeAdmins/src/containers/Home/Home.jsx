...
import  {login}  from '../../redux/actions/auth/auth.js'
          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                maxLength={100}
                className={`bg-stone-800 relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-300 placeholder-gray-400 focus:z-10 focus:border-azul_corp_ho focus:outline-none focus:ring-azul_corp_ho sm:text-sm ${
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                maxLength={50}
                className={`bg-stone-800 relative block w-full appearance-none rounded-none rounded-b-md border border-gray-300 px-3 py-2 text-gray-300 placeholder-gray-400 focus:z-10 focus:border-azul_corp_ho focus:outline-none focus:ring-azul_corp_ho sm:text-sm ${
